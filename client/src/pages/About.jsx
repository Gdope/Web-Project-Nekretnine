  ...
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      ...
      <p className="mb-4 text-slate-700">
        Stefan Estate is a leading real estate agency that specializes in
      ...
      <p className="mb-4 text-slate-700">
        If you have any other questions or if you would like to work for us,{" "}
        <br />
        please call +381 65 844 333 0
      </p>
    </div>
  );
}
